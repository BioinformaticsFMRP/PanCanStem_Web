...
Notice the the size of this matirx is now 11809 rows by 11069 columns. 
```{r}
rownames(X) <- NULL
...
Score the Matrix 'X' using Spearman coorelation. 
```{r}
...
Once you have created all of the 'genes2hugo' 'main.train' 'main.predict' and 'f' create the `main` function. This function will train and apply the full and reduced signatures. After you have have created all of the functions run `main` to preform the full analysis. 
```{r}
main <- function()
{
